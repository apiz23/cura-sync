...
import { ModeToggle } from "./animated-theme-toggler";
...
interface FlexNavbarProps {
    ...
    animationEasing?: [number, number, number, number];
                ...
                >
                    ...
                    >
                        ...
                        >
                            <motion.span
                                className={cn(
                                    "absolute w-full bg-black dark:bg-white"
                                )}
