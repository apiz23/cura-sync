        ...
        return (
            ...
            >
                <div className="absolute inset-0 overflow-hidden">
                    {/* Radial glow ikut accent */}
                    <div
                        aria-hidden
                        className="absolute inset-0 opacity-60"
                        style={{
                            background:
                                "radial-gradient(circle at 20% 15%, color-mix(in srgb, var(--accent) 50%, transparent), transparent 70%)",
                        }}
                    />
                    <div
                        aria-hidden
                        ...
                        style={{
                            background:
                                "radial-gradient(circle at 80% 10%, color-mix(in srgb, var(--accent) 40%, transparent), transparent 75%)",
                        }}
                    />
                    {rays.map((ray) => (
                        <Ray key={ray.id} {...ray} />
