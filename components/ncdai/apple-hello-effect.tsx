		...
		>
			...
			<motion.path
				...
				transition={{
					...
					ease: "easeOut",
					delay: calc(0.1),
					opacity: { duration: 0.08, delay: calc(0.1) },
				}}
			/>
            ...
            <motion.path
                ...
                animate={animateProps}
                transition={{
                    duration: calc(0.12), // Reduced from 0.2
                    ease: "easeOut",
                    delay: calc(0.2), // Reduced from 0.3
                    opacity: { duration: 0.08, delay: calc(0.2) },
                }}
            />
            <motion.path
                ...
                transition={{
                    duration: calc(0.12), // Reduced from 0.2
                    ease: "easeOut",
                    delay: calc(0.25), // Reduced from 0.4
                    opacity: { duration: 0.08, delay: calc(0.25) },
                }}
            />
            ...
            <motion.path
                ...
                animate={animateProps}
                transition={{
                    duration: calc(0.15), // Reduced from 0.25
                    ease: "easeOut",
                    delay: calc(0.32), // Reduced from 0.5
                    opacity: { duration: 0.08, delay: calc(0.32) },
                }}
            />
            <motion.path
                ...
                transition={{
                    duration: calc(0.15), // Reduced from 0.25
                    ease: "easeOut",
                    delay: calc(0.42), // Reduced from 0.65
                    opacity: { duration: 0.08, delay: calc(0.42) },
                }}
            />
            ...
            <motion.path
                ...
                animate={animateProps}
                transition={{
                    duration: calc(0.18), // Reduced from 0.3
                    ease: "easeInOut",
                    delay: calc(0.5), // Reduced from 0.8
            ...
            <motion.path
                ...
                transition={{
                    duration: calc(0.15), // Reduced from 0.25
                    ease: "easeOut",
                    delay: calc(0.6), // Reduced from 1.0
                    opacity: { duration: 0.08, delay: calc(0.6) },
                }}
            />
            ...
            <motion.path
                ...
                transition={{
                    duration: calc(0.18), // Reduced from 0.3
                    ease: "easeInOut",
                    delay: calc(0.7), // Reduced from 1.15
            ...
            <motion.path
                ...
                transition={{
                    duration: calc(0.12), // Reduced from 0.2
                    ease: "easeOut",
                    delay: calc(0.8), // Reduced from 1.35
                    opacity: { duration: 0.08, delay: calc(0.8) },
                }}
            />
            ...
            <motion.path
                ...
                transition={{
                    duration: calc(0.15), // Reduced from 0.25
                    ease: "easeOut",
                    delay: calc(0.9), // Reduced from 1.45
                    opacity: { duration: 0.08, delay: calc(0.9) },
                }}
            />
            ...
            <motion.path
                ...
                transition={{
                    duration: calc(0.15), // Reduced from 0.25
                    ease: "easeInOut",
                    delay: calc(1.0), // Reduced from 1.6
                    opacity: { duration: 0.08, delay: calc(1.0) },
                }}
            />

            {/* accent mark - faster */}
            <motion.path
                className="stroke-cyan-400 dark:stroke-cyan-400 stroke-blue-600" // Added light mode color
                ...
                transition={{
                    duration: calc(0.12), // Reduced from 0.2
                    ease: "easeInOut",
                    delay: calc(1.1), // Reduced from 1.75
                    opacity: { duration: 0.08, delay: calc(1.1) },
                }}
                onAnimationComplete={onAnimationComplete}
            />
        </motion.svg>
		...
		<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-8">
			<div className="max-w-4xl w-full space-y-12">
				<div className="text-center space-y-4">
					...
					<p className="text-slate-300">Beautiful handwritten-style animations</p>
				</div>
